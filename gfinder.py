...
<header>
    <div class="logo-container" style="display: flex; align-items: center; justify-content: center; margin: 1.5rem 0 2rem 0;">
        ...
        <h1 style="font-size: 3rem; font-weight: 700; margin: 0; background: linear-gradient(90deg, #003399, #00C8C8); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-family: 'Inter', sans-serif; letter-spacing: -0.5px;">GTrace</h1>
    </div>
...
<script>
    ...
    function renderResults(items, stats, limitReached) {
        ...
        let warningBtn = '';
        if (limitReached) {
            warningBtn = `<button class="btn-warning" onclick="startSearch(true)">⚠️ Continue Deep Scan?</button>`;
        }
